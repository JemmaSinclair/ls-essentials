...
RegisterCommand ("lls1", function()
    RemoveAllPedWeapons(GetPlayerPed(-1), true)
        ...
        giveWeapon("WEAPON_PUMPSHOTGUN")
        giveWeapon("WEAPON_STUNGUN")
        notify('~r~LLS1 Loadout has been given.')
end, false)
TriggerEvent('chat:addSuggestion', '/lls1', 'Loads the standard Lock and Load Security Loadout')
